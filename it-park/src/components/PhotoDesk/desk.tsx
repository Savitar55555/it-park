      ...
      <div className={styles.block}>
        ...
        <div className={styles.title}>
          ...
          <div className={styles.photo_big1}>
            <Image className={styles.photo} src="/Images/photoDesk/photo1.png" alt="d" width={184} height={184} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={32} height={32} />
          </div>
          <div className={styles.photo_big2}>
            <Image className={styles.photo} src="/Images/photoDesk/photo2.png" alt="d" width={184} height={187} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={32} height={32} />
          </div>
          <div className={styles.photo_mid1}>
            <Image className={styles.photo} src="/Images/photoDesk/photo3.png" alt="d" width={120} height={121} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={21} height={21} />
          </div>
          <div className={styles.photo_small}>
            <Image className={styles.photo} src="/Images/photoDesk/photo4.png" alt="d" width={110} height={110} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={20} height={20} />
          </div>
          <div className={styles.photo_mid2}>
            <Image className={styles.photo} src="/Images/photoDesk/photo5.png" alt="d" width={120} height={120} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={20} height={20} />
          </div>
          <div className={styles.photo_big3}>
            <Image className={styles.photo} src="/Images/photoDesk/photo6.png" alt="d" width={184} height={185} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={32} height={32} />
          </div>
          <div className={styles.photo_mid3}>
            <Image className={styles.photo} src="/Images/photoDesk/photo7.png" alt="d" width={120} height={120} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={20} height={20} />
          </div>
          <div className={styles.photo_mid4}>
            <Image className={styles.photo} src="/Images/photoDesk/photo8.png" alt="d" width={120} height={119} />
            <Image className={styles.icons} src="/Images/photoDesk/icon1.svg" alt="" width={20} height={20} />
          </div>
